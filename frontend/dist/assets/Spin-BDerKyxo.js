import{E as T,M as v,N as d,bL as w,aj as b,d as B,bM as N,H as S,o as m,a as h,Y as f,O as l,b as z,aa as y,e as R,aH as V,m as P,J as $,an as L,ae as j,g,j as E,aF as M,aB as O,ao as W}from"./index-Bu5TJTFN.js";import{u as _}from"./use-compitable-BRSNpx9D.js";function I(e){const{opacityDisabled:t,heightTiny:o,heightSmall:p,heightMedium:a,heightLarge:n,heightHuge:r,primaryColor:s,fontSize:i}=e;return{fontSize:i,textColor:s,sizeTiny:o,sizeSmall:p,sizeMedium:a,sizeLarge:n,sizeHuge:r,color:s,opacitySpinning:t}}const D={common:T,self:I};var H=v([v("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
