import{bZ as no,d as Me,H as ie,aj as io,o as c,a as v,F as O,Y as w,b_ as lo,aa as A,O as x,J as Te,T as so,g as S,ai as co,b$ as uo,au as Se,E as ho,M as G,N as r,ac as b,ad as oe,aB as Re,bU as fo,bV as vo,c0 as mo,b as he,e as te,P as po,k as E,R as ze,ay as go,ah as Ce,aI as bo,U as ae,W as re,bl as ne,$ as xo,aA as wo,V as fe,a2 as yo}from"./index-BrC03CDs.js";import{g as ko}from"./get-slot-VaplJ9hC.js";import{u as me,V as So,e as Ro,B as zo}from"./Tag-Cc6g-_Kw.js";import{u as Co}from"./use-merged-state-yQdzVvcc.js";var Bo={gapSmall:"4px 8px",gapMedium:"8px 12px",gapLarge:"12px 16px"};function $o(){return Bo}const Mo={self:$o};let ve;function To(){if(!no)return!0;if(ve===void 0){const o=document.createElement("div");o.style.display="flex",o.style.flexDirection="column",o.style.rowGap="1px",o.appendChild(document.createElement("div")),o.appendChild(document.createElement("div")),document.body.appendChild(o);const h=o.scrollHeight===1;return document.body.removeChild(o),ve=h}return ve}const Do={...ie.props,align:String,justify:{type:String,default:"start"},inline:Boolean,vertical:Boolean,reverse:Boolean,size:[String,Number,Array],wrapItem:{type:Boolean,default:!0},itemClass:String,itemStyle:[String,Object],wrap:{type:Boolean,default:!0},internalUseGap:{type:Boolean,default:void 0}};var Oo=Me({name:"Space",props:Do,setup(o){const{mergedClsPrefixRef:h,mergedRtlRef:y,mergedComponentPropsRef:u}=Te(o),i=S(()=>{var s,z;return o.size??((z=(s=u==null?void 0:u.value)==null?void 0:s.Space)==null?void 0:z.size)??"medium"}),d=ie("Space","-space",void 0,Mo,o,h),R=so("Space",y,h);return{useGap:To(),rtlEnabled:R,mergedClsPrefix:h,margin:S(()=>{const s=i.value;if(Array.isArray(s))return{horizontal:s[0],vertical:s[1]};if(typeof s=="number")return{horizontal:s,vertical:s};const{self:{[co("gap",s)]:z}}=d.value,{row:D,col:M}=uo(z);return{horizontal:Se(M),vertical:Se(D)}})}},render(){const{vertical:o,reverse:h,align:y,inline:u,justify:i,itemClass:d,itemStyle:R,margin:s,wrap:z,mergedClsPrefix:D,rtlEnabled:M,useGap:C,wrapItem:U,internalUseGap:W}=this,V=io(ko(this),!1);if(!V.length)return null;const K=`${s.horizontal}px`,F=`${s.horizontal/2}px`,g=`${s.vertical}px`,T=`${s.vertical/2}px`,H=V.length-1,P=i.startsWith("space-");return c(),v("div",{role:"none",class:x([`${D}-space`,M&&`${D}-space--rtl`]),style:A({display:u?"inline-flex":"flex",flexDirection:o&&!h?"column":o&&h?"column-reverse":!o&&h?"row-reverse":"row",justifyContent:["start","end"].includes(i)?`flex-${i}`:i,flexWrap:!z||o?"nowrap":"wrap",marginTop:C||o?"":`-${T}`,marginBottom:C||o?"":`-${T}`,alignItems:y,gap:C?`${s.vertical}px ${s.horizontal}px`:""})},[!U&&(C||W)?(c(),v(O,{key:0},[w(()=>V)],64)):(c(),v(O,{key:1},[w(()=>V.map((m,B)=>m.type===lo?m:(c(),v("div",{key:1,role:"none",class:x(d),style:A([R,{maxWidth:"100%"},C?"":o?{marginBottom:B!==H?g:""}:M?{marginLeft:P?i==="space-between"&&B===H?"":F:B!==H?K:"",marginRight:P?i==="space-between"&&B===0?"":F:"",paddingTop:T,paddingBottom:T}:{marginRight:P?i==="space-between"&&B===H?"":F:B!==H?K:"",marginLeft:P?i==="space-between"&&B===0?"":F:"",paddingTop:T,paddingBottom:T}])},[w(()=>m)],6))))],64))],6)}}),Vo={railHeight:"4px",railWidthVertical:"4px",handleSize:"18px",dotHeight:"8px",dotWidth:"8px",dotBorderRadius:"4px"};function Fo(o){const h="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:u,primaryColor:i,baseColor:d,cardColor:R,modalColor:s,popoverColor:z,borderRadius:D,fontSize:M,opacityDisabled:C}=o;return{...Vo,fontSize:M,markFontSize:M,railColor:u,railColorHover:u,fillColor:i,fillColorHover:i,opacityDisabled:C,handleColor:"#FFF",dotColor:R,dotColorModal:s,dotColorPopover:z,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:h,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:D,dotBorder:`2px solid ${u}`,dotBorderActive:`2px solid ${i}`,dotBoxShadow:""}}const Io={common:ho,self:Fo};var Eo=G([r("slider",`
 display: block;
