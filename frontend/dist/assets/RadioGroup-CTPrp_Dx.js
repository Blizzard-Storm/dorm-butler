import{E as he,ai as O,N as B,aj as x,ak as f,M as S,al as j,ab as fe,J as G,P as Y,j as I,Q as W,am as ve,U as A,a2 as N,d as K,H,K as ge,o as $,a as T,b as E,Y as V,O as C,X as q,aa as J,T as Q,an as X,g as P,ao as U,e as pe,ap as me,aq as xe}from"./index-Bu5TJTFN.js";import{g as Ce}from"./get-slot-VaplJ9hC.js";import{u as Z}from"./use-merged-state-bp4yCixx.js";var Re={radioSizeSmall:"14px",radioSizeMedium:"16px",radioSizeLarge:"18px",labelPadding:"0 8px",labelFontWeight:"400"};function we(o){const{borderColor:e,primaryColor:t,baseColor:r,textColorDisabled:d,inputColorDisabled:b,textColor2:u,opacityDisabled:l,borderRadius:n,fontSizeSmall:c,fontSizeMedium:v,fontSizeLarge:h,heightSmall:g,heightMedium:R,heightLarge:p,lineHeight:w}=o;return{...Re,labelLineHeight:w,buttonHeightSmall:g,buttonHeightMedium:R,buttonHeightLarge:p,fontSizeSmall:c,fontSizeMedium:v,fontSizeLarge:h,boxShadow:`inset 0 0 0 1px ${e}`,boxShadowActive:`inset 0 0 0 1px ${t}`,boxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.2})}`,boxShadowHover:`inset 0 0 0 1px ${t}`,boxShadowDisabled:`inset 0 0 0 1px ${e}`,color:r,colorDisabled:b,colorActive:"#0000",textColor:u,textColorDisabled:d,dotColorActive:t,dotColorDisabled:e,buttonBorderColor:e,buttonBorderColorActive:t,buttonBorderColorHover:e,buttonColor:r,buttonColorActive:r,buttonTextColor:u,buttonTextColorActive:t,buttonTextColorHover:t,opacityDisabled:l,buttonBoxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.3})}`,buttonBoxShadowHover:"inset 0 0 0 1px #0000",buttonBoxShadow:"inset 0 0 0 1px #0000",buttonBorderRadius:n}}const ee={common:he,self:we};var Se=B("radio",`
...
`,[f("splitor",`
 ...
 `),j("checked",{color:"var(--n-button-text-color-hover)"})]),x("focus",[S("&:not(:active)",[f("state-border",{boxShadow:"var(--n-button-box-shadow-focus)"})])])]),x("checked",`
 ...
 `)])]);const $e=["onFocusin","onFocusout"];function Fe(o,e,t){var b;const r=[];let d=!1;for(let u=0;u<o.length;++u){const l=o[u],n=(b=l.type)==null?void 0:b.name;n==="RadioButton"&&(d=!0);const c=l.props;if(n!=="RadioButton"){r.push(l);continue}if(u===0)r.push(l);else{const v=r[r.length-1].props,h=e===v.value,g=v.disabled,R=e===c.value,p=c.disabled,w=(h?2:0)+(g?0:1),z=(R?2:0)+(p?0:1),y={[`${t}-radio-group__splitor--disabled`]:g,[`${t}-radio-group__splitor--checked`]:h},_={[`${t}-radio-group__splitor--disabled`]:p,[`${t}-radio-group__splitor--checked`]:R},k=w<z?_:y;r.push(($(),T("div",{key:1,class:C([`${t}-radio-group__splitor`,k])},null,2)),l)}}return{children:r,isButtonGroup:d}}const De={...H.props,name:String,options:Array,labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]};var Ee=K({name:"RadioGroup",props:De,setup(o){const e=I(null),{mergedSizeRef:t,mergedDisabledRef:r,nTriggerFormChange:d,nTriggerFormInput:b,nTriggerFormBlur:u,nTriggerFormFocus:l}=Y(o),{mergedClsPrefixRef:n,inlineThemeDisabled:c,mergedRtlRef:v}=G(o),h=H("Radio","-radio-group",Be,ee,o,n),g=I(o.defaultValue),R=N(o,"value"),p=Z(R,g);function w(i){const{onUpdateValue:s,"onUpdate:value":m}=o;s&&A(s,i),m&&A(m,i),g.value=i,d(),b()}function z(i){const{value:s}=e;s&&(s.contains(i.relatedTarget)||l())}function y(i){const{value:s}=e;s&&(s.contains(i.relatedTarget)||u())}xe(te,{mergedClsPrefixRef:n,nameRef:N(o,"name"),valueRef:p,disabledRef:r,mergedSizeRef:t,doUpdateValue:w});const _=Q("Radio",v,n),k=P(()=>{const{value:i}=t,{common:{cubicBezierEaseInOut:s},self:{buttonBorderColor:m,buttonBorderColorActive:F,buttonBorderRadius:D,buttonBoxShadow:M,buttonBoxShadowFocus:L,buttonBoxShadowHover:ae,buttonColor:ne,buttonColorActive:ie,buttonTextColor:de,buttonTextColorActive:le,buttonTextColorHover:se,opacityDisabled:ue,[U("buttonHeight",i)]:ce,[U("fontSize",i)]:be}}=h.value;return{"--n-font-size":be,"--n-bezier":s,"--n-button-border-color":m,"--n-button-border-color-active":F,"--n-button-border-radius":D,"--n-button-box-shadow":M,"--n-button-box-shadow-focus":L,"--n-button-box-shadow-hover":ae,"--n-button-color":ne,"--n-button-color-active":ie,"--n-button-text-color":de,"--n-button-text-color-hover":se,"--n-button-text-color-active":le,"--n-height":ce,"--n-opacity-disabled":ue}}),a=c?X("radio-group",P(()=>t.value[0]),k,o):void 0;return{selfElRef:e,rtlEnabled:_,mergedClsPrefix:n,mergedValue:p,handleFocusout:y,handleFocusin:z,cssVars:c?void 0:k,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender}},render(){var c;const{mergedValue:o,mergedClsPrefix:e,handleFocusin:t,handleFocusout:r}=this,{options:d,labelField:b,valueField:u}=this.$props,{children:l,isButtonGroup:n}=Fe(d?d.map(v=>{const h=v[u];return $(),pe(ye,{key:typeof h=="boolean"?`__n_${h}`:h,value:h,disabled:v.disabled,label:v[b]},null,8,["value","disabled","label"])}):me(Ce(this)),o,e);return(c=this.onRender)==null||c.call(this),$(),T("div",{onFocusin:t,onFocusout:r,ref:"selfElRef",class:C([`${e}-radio-group`,this.rtlEnabled&&`${e}-radio-group--rtl`,this.themeClass,n&&`${e}-radio-group--button-group`]),style:J(this.cssVars)},[V(()=>l)],46,$e)}});export{Ee as R,Ae as a};
