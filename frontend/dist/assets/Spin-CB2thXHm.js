import{E as T,M as v,N as d,bN as w,aj as b,d as B,bO as N,H as S,o as m,a as h,Y as f,O as l,b as z,aa as y,e as R,aH as V,j as P,J as $,an as O,ae as j,g,k as E,aF as L,aB as W,ao as _}from"./index-DFGY6xA0.js";import{u as I}from"./use-compitable-DkA_JIwt.js";function M(e){const{opacityDisabled:t,heightTiny:o,heightSmall:p,heightMedium:a,heightLarge:n,heightHuge:r,primaryColor:s,fontSize:i}=e;return{fontSize:i,textColor:s,sizeTiny:o,sizeSmall:p,sizeMedium:a,sizeLarge:n,sizeHuge:r,color:s,opacitySpinning:t}}const D={common:T,self:M};var H=v([v("@keyframes spin-rotate",`
 from {
 transform: rotate(0);
 }
 to {
